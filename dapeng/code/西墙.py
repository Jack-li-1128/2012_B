...
def draw_panels_on_wall(ax, panel_length, panel_width, color, wall_coords, existing_panels):
    panel_count = 0
    panel_positions = []
...
# Draw main panels
main_panel_count, main_panel_positions = draw_panels_on_wall(ax, main_panel_length, main_panel_width, 'blue', wall_coords, existing_panels)
existing_panels.extend(main_panel_positions)

# Draw additional panels
additional_panel_count, additional_panel_positions = draw_panels_on_wall(ax, additional_panel_length, additional_panel_width, 'green', wall_coords, existing_panels)
existing_panels.extend(additional_panel_positions)

# Draw smaller panels
smaller_panel_count, smaller_panel_positions = draw_panels_on_wall(ax, smaller_panel_length, smaller_panel_width, 'purple', wall_coords, existing_panels)
